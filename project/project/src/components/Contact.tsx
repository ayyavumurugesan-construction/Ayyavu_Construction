...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-20 relative bg-gradient-to-br from-blue-900/10 via-blue-800/10 to-green-900/10">
      <div 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 relative z-10">
          <div>
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4 hover:scale-105 hover:bg-white/10 p-4 rounded-lg transition-all duration-300 cursor-pointer backdrop-blur-sm border border-white/20">
                <Phone className="h-6 w-6 text-blue-400 flex-shrink-0 mt-1" />
                <div>
                  <div className="font-medium text-white">Phone</div>
                  <div className="text-white/80"><a href="tel:+91 93604 93616">+91 93604 93616</a></div>
                  <div className="text-white/80"><a href="tel:+91 93457 70330">+91 93457 70330</a></div>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4 hover:scale-105 hover:bg-white/10 p-4 rounded-lg transition-all duration-300 cursor-pointer backdrop-blur-sm border border-white/20">
                ...
                <div>
                  ...
                  <div className="text-white/80"><a href="mailto:ayyavu.ayyavupromoters@gmail.com">ayyavu.ayyavuconstruction@gmail.com </a></div>
              ...
              <div className="flex items-start space-x-4 hover:scale-105 hover:bg-white/10 p-4 rounded-lg transition-all duration-300 cursor-pointer backdrop-blur-sm border border-white/20">
                ...
                <div>
                  ...
                  <div className="text-white/80">Monday - Saturday: 9:00 AM - 7:00 PM</div>
                  <div className="text-white/80">Sunday: 10:00 AM - 5:00 PM</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div>
            <h3 className="text-2xl font-semibold text-white mb-8 drop-shadow-lg">Send Us a Message</h3>
