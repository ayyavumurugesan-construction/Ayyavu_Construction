/*
  ...
  2. Security
    ...
    - Add policies for public read access to approved property listings
    - Add policies for contact message creation
...
CREATE POLICY "Users can read their own property listings"
  ON property_listings
  FOR SELECT
  TO authenticated
...
CREATE POLICY "Public can read approved property listings"
  ON property_listings
  FOR SELECT
  TO public
